// ===========================
// frontend/src/types/index.ts - Complete Frontend Type Definitions
// ===========================
...
export interface CreateTeamRequest {
  ...
  displayName?: string
  description?: string
  members: Omit<TeamMember, 'id' | 'createdAt' | 'updatedAt'>[]
  skills: ServiceType[]
  specializations?: string[]
  phone: string
  email?: string
...
export interface CreateProductRequest {
  ...
  features: string[]
  images: File[]
  supplier?: Omit<ProductSupplier, 'id' | 'createdAt' | 'updatedAt'>
  warrantyPeriod?: string
  installationRequired?: boolean
  installationCharge?: number
  tags: string[]
...
export interface AdminStore {
  ...
  updateBookingStatus: (id: string, data: UpdateBookingRequest) => Promise<void>
